#!/bin/bash
#
# run_ortho2.sh – LAMMPS ortho2 production run on 2x 128-core node
#

#SBATCH --job-name=ortho2
#SBATCH --account=25fa-mse4851a-eng
#SBATCH --partition=eng-instruction
#SBATCH --nodes=2
#SBATCH --ntasks=256
#SBATCH --time=12:00:00
#SBATCH --output=ortho2_%j.out
#SBATCH --error=ortho2_%j.err
...
mpirun -np 256 lmp_mpi -in ortho2.in > ortho2.out
